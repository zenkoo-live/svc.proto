...
var file_svc_biz_room_mq_proto_goTypes = []interface{}{
...
func file_svc_biz_room_mq_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_svc_biz_room_mq_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_svc_biz_room_mq_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
