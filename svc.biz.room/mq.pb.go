...
type RoomStopLiveTopicInfo struct {
	...
	Room        *RoomInfo              `protobuf:"bytes,1,opt,name=room,proto3" json:"room,omitempty"`
	StartStopAt *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=start_stop_at,json=startStopAt,proto3" json:"start_stop_at,omitempty"` // 开播时间
}
...
func (x *RoomStopLiveTopicInfo) GetStartStopAt() *timestamppb.Timestamp {
	if x != nil {
		return x.StartStopAt
	}
	return nil
}
...
var file_svc_biz_room_mq_proto_rawDesc = []byte{
	...
	0x4c, 0x69, 0x76, 0x65, 0x41, 0x74, 0x22, 0x83, 0x01, 0x0a, 0x15, 0x52, 0x6f, 0x6f, 0x6d, 0x53,
	...
	0x6f, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x12, 0x3e, 0x0a, 0x0d,
	0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x73, 0x74, 0x6f, 0x70, 0x5f, 0x61, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52,
	0x0b, 0x73, 0x74, 0x61, 0x72, 0x74, 0x53, 0x74, 0x6f, 0x70, 0x41, 0x74, 0x42, 0x15, 0x5a, 0x13,
...
var (
	...
	file_svc_biz_room_mq_proto_rawDescData = file_svc_biz_room_mq_proto_rawDesc
)

func file_svc_biz_room_mq_proto_rawDescGZIP() []byte {
	file_svc_biz_room_mq_proto_rawDescOnce.Do(func() {
		file_svc_biz_room_mq_proto_rawDescData = protoimpl.X.CompressGZIP(file_svc_biz_room_mq_proto_rawDescData)
	})
...
var file_svc_biz_room_mq_proto_depIdxs = []int32{
	...
	3, // 3: svc.biz.room.RoomStopLiveTopicInfo.start_stop_at:type_name -> google.protobuf.Timestamp
...
func file_svc_biz_room_mq_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_svc_biz_room_mq_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*RoomStartLiveTopicInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_svc_biz_room_mq_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*RoomStopLiveTopicInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_svc_biz_room_mq_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_svc_biz_room_mq_proto_rawDesc = nil
