...
type RoomInfo struct {
	...
	LiveStatus      LiveStatus             `protobuf:"varint,11,opt,name=live_status,json=liveStatus,proto3,enum=svc.biz.room.LiveStatus" json:"live_status,omitempty"`                       // 房间状态：1关播，2开播
	LiveId          string                 `protobuf:"bytes,12,opt,name=live_id,json=liveId,proto3" json:"live_id,omitempty"`                                                                 // 直播id（开播状态时才会有，关播时清空）
	LiveDisplayType LiveDisplayType        `protobuf:"varint,13,opt,name=live_display_type,json=liveDisplayType,proto3,enum=svc.biz.room.LiveDisplayType" json:"live_display_type,omitempty"` // 横竖屏类型（开播状态时才会有，关播时清空）
	LiveStartAt     *timestamppb.Timestamp `protobuf:"bytes,14,opt,name=live_start_at,json=liveStartAt,proto3" json:"live_start_at,omitempty"`                                                // 开播时间（开播状态时才会有，关播时清空）
	ScoreRecommend  int32                  `protobuf:"varint,101,opt,name=score_recommend,json=scoreRecommend,proto3" json:"score_recommend,omitempty"`                                       // 推荐分数（后台配置）
	ScoreSearch     int32                  `protobuf:"varint,102,opt,name=score_search,json=scoreSearch,proto3" json:"score_search,omitempty"`                                                // 搜索分数（后台配置）
	ScoreSubscribe  int32                  `protobuf:"varint,103,opt,name=score_subscribe,json=scoreSubscribe,proto3" json:"score_subscribe,omitempty"`                                       // 关注分数（后台配置）
	ScoreHot        int32                  `protobuf:"varint,104,opt,name=score_hot,json=scoreHot,proto3" json:"score_hot,omitempty"`                                                         // 热度分数（后台配置）
...
var file_svc_biz_room_room_proto_rawDesc = []byte{
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf7, 0x05, 0x0a, 0x08, 0x52, 0x6f, 0x6f, 0x6d,
	...
	0x6f, 0x12, 0x39, 0x0a, 0x0b, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x52, 0x0a, 0x6c, 0x69, 0x76, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x17, 0x0a, 0x07,
	0x6c, 0x69, 0x76, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6c,
	0x69, 0x76, 0x65, 0x49, 0x64, 0x12, 0x49, 0x0a, 0x11, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x64, 0x69,
	0x73, 0x70, 0x6c, 0x61, 0x79, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0e,
	...
	0x65, 0x6e, 0x64, 0x18, 0x65, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x73, 0x63, 0x6f, 0x72, 0x65,
	0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x63, 0x6f,
	0x72, 0x65, 0x5f, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x18, 0x66, 0x20, 0x01, 0x28, 0x05, 0x52,
	...
	,
	...
	0x6f, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x6d, 0x22, 0x88, 0x01, 0x0a,
	0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x71, 0x12, 0x0e,
	...
	0x61, 0x74, 0x65, 0x4d, 0x61, 0x73, 0x6b, 0x22, 0x1c, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x52, 0x6f,
	0x6f, 0x6d, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x39, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x6f, 0x6d,
	...
	0x6f, 0x6f, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x71,
	...
	0x65, 0x22, 0x28, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4c, 0x69, 0x76, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x12, 0x17, 0x0a, 0x07, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x69, 0x76, 0x65, 0x49, 0x64, 0x22, 0x2e, 0x0a, 0x0b, 0x53,
	...
	0x74, 0x6f, 0x70, 0x4c, 0x69, 0x76, 0x65, 0x52, 0x65, 0x73, 0x70, 0x2a, 0x69, 0x0a, 0x0f, 0x4c,
	...
	0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x10, 0x02, 0x32, 0xa7, 0x03, 0x0a, 0x04, 0x52, 0x6f, 0x6f,
	...
	0x6d, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x12, 0x4a, 0x0a,
	...
	0x6d, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x44, 0x0a, 0x09, 0x53, 0x74, 0x61,
