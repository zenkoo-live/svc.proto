...
func file_svc_biz_trade_trade_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_svc_biz_trade_trade_proto_msgTypes[44].Exporter = func(v any, i int) any {
			switch v := v.(*CoinRechargeReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_svc_biz_trade_trade_proto_msgTypes[45].Exporter = func(v any, i int) any {
			switch v := v.(*StreamerWageReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_svc_biz_trade_trade_proto_msgTypes[46].Exporter = func(v any, i int) any {
