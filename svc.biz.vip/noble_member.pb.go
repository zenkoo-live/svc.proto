...
type MGetNobleMemberResp struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Items         map[string]*NobleMemberInfo `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_svc_biz_vip_noble_member_proto_rawDesc = string([]byte{
...
var (
	...
	file_svc_biz_vip_noble_member_proto_rawDescData []byte
)

func file_svc_biz_vip_noble_member_proto_rawDescGZIP() []byte {
	file_svc_biz_vip_noble_member_proto_rawDescOnce.Do(func() {
		file_svc_biz_vip_noble_member_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_svc_biz_vip_noble_member_proto_rawDesc), len(file_svc_biz_vip_noble_member_proto_rawDesc)))
	})
...
func file_svc_biz_vip_noble_member_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_svc_biz_vip_noble_member_proto_rawDesc), len(file_svc_biz_vip_noble_member_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   1,
