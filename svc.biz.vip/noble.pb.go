...
func (x *GetNobleReq) GetLevel() NobleLevel {
	if x != nil {
		return x.Level
	}
...
func (x *UpdateNobleReq) GetLevel() NobleLevel {
	if x != nil {
		return x.Level
	}
	return NobleLevel_NobleLevelUnknown
...
type NobleInfo struct {
	...
	Icon                   string                     `protobuf:"bytes,7,opt,name=icon,proto3" json:"icon,omitempty"`                                                                          // 身份标签
	RightsAvoidKick        bool                       `protobuf:"varint,101,opt,name=rights_avoid_kick,json=rightsAvoidKick,proto3" json:"rights_avoid_kick,omitempty"`                        // 防踢
	RightsAvoidBanSpeaking bool                       `protobuf:"varint,102,opt,name=rights_avoid_ban_speaking,json=rightsAvoidBanSpeaking,proto3" json:"rights_avoid_ban_speaking,omitempty"` // 防禁言
	RightsIdentityIcon     bool                       `protobuf:"varint,103,opt,name=rights_identity_icon,json=rightsIdentityIcon,proto3" json:"rights_identity_icon,omitempty"`               // 身份标签（所有贵族都有，此字段不入库默认为true）
	RightsUpgradeAddition  int32                      `protobuf:"varint,104,opt,name=rights_upgrade_addition,json=rightsUpgradeAddition,proto3" json:"rights_upgrade_addition,omitempty"`      // 升级加成（保存的是加成比例，20%的话，存的是数字20）
	RightsInroomEffect     bool                       `protobuf:"varint,105,opt,name=rights_inroom_effect,json=rightsInroomEffect,proto3" json:"rights_inroom_effect,omitempty"`               // 进场特效（所有贵族都有，此字段不入库默认为true）
	RightsBarrageColors    []string                   `protobuf:"bytes,106,rep,name=rights_barrage_colors,json=rightsBarrageColors,proto3" json:"rights_barrage_colors,omitempty"`             // 弹幕颜色
	RightsRemandDiamond    bool                       `protobuf:"varint,107,opt,name=rights_remand_diamond,json=rightsRemandDiamond,proto3" json:"rights_remand_diamond,omitempty"`            // 专属俸禄（所有贵族都有，此字段不入库默认为true）
	RightsMounts           []string                   `protobuf:"bytes,108,rep,name=rights_mounts,json=rightsMounts,proto3" json:"rights_mounts,omitempty"`                                    // 坐骑（进场特效）
	RightsFreeGifts        []*NobleRightsFreeGift     `protobuf:"bytes,109,rep,name=rights_free_gifts,json=rightsFreeGifts,proto3" json:"rights_free_gifts,omitempty"`                         // 免费礼物
	RightsNobleGift        bool                       `protobuf:"varint,110,opt,name=rights_noble_gift,json=rightsNobleGift,proto3" json:"rights_noble_gift,omitempty"`                        // 专属礼物（所有贵族都有，此字段不入库默认为true）
	RightsIntoRoomHide     bool                       `protobuf:"varint,111,opt,name=rights_into_room_hide,json=rightsIntoRoomHide,proto3" json:"rights_into_room_hide,omitempty"`             // 进场隐身
	RightsRankHide         bool                       `protobuf:"varint,112,opt,name=rights_rank_hide,json=rightsRankHide,proto3" json:"rights_rank_hide,omitempty"`                           // 榜单隐身
	RightsDiscountGifts    []*NobleRightsDiscountGift `protobuf:"bytes,113,rep,name=rights_discount_gifts,json=rightsDiscountGifts,proto3" json:"rights_discount_gifts,omitempty"`             // 特价礼物
...
func (x *NobleInfo) GetRightsAvoidKick() bool {
	if x != nil {
...
func (x *NobleInfo) GetRightsAvoidBanSpeaking() bool {
	if x != nil {
...
func (x *NobleInfo) GetRightsIdentityIcon() bool {
	if x != nil {
...
func (x *NobleInfo) GetRightsUpgradeAddition() int32 {
	if x != nil {
...
func (x *NobleInfo) GetRightsInroomEffect() bool {
	if x != nil {
...
func (x *NobleInfo) GetRightsBarrageColors() []string {
	if x != nil {
...
func (x *NobleInfo) GetRightsRemandDiamond() bool {
	if x != nil {
...
func (x *NobleInfo) GetRightsMounts() []string {
	if x != nil {
...
func (x *NobleInfo) GetRightsFreeGifts() []*NobleRightsFreeGift {
	if x != nil {
...
func (x *NobleInfo) GetRightsNobleGift() bool {
	if x != nil {
...
func (x *NobleInfo) GetRightsIntoRoomHide() bool {
	if x != nil {
...
func (x *NobleInfo) GetRightsRankHide() bool {
	if x != nil {
...
func (x *NobleInfo) GetRightsDiscountGifts() []*NobleRightsDiscountGift {
	if x != nil {
...
var file_svc_biz_vip_noble_proto_rawDesc = []byte{
	...
	,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0xaa, 0x01, 0x0a, 0x0e,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x12, 0x2d,
	...
	,
	...
	,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x40, 0x0a, 0x13, 0x4e, 0x6f, 0x62, 0x6c,
	0x65, 0x52, 0x69, 0x67, 0x68, 0x74, 0x73, 0x46, 0x72, 0x65, 0x65, 0x47, 0x69, 0x66, 0x74, 0x12,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0x59, 0x0a, 0x17, 0x4e, 0x6f,
	0x62, 0x6c, 0x65, 0x52, 0x69, 0x67, 0x68, 0x74, 0x73, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x47, 0x69, 0x66, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x67, 0x69, 0x66, 0x74, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x67, 0x69, 0x66, 0x74, 0x49, 0x64, 0x12, 0x25,
	...
	,
	...
	0x73, 0x70, 0x22, 0x00, 0x12, 0x4a, 0x0a, 0x0b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f,
	0x62, 0x6c, 0x65, 0x12, 0x1b, 0x2e, 0x73, 0x76, 0x63, 0x2e, 0x62, 0x69, 0x7a, 0x2e, 0x76, 0x69,
	0x70, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x71,
	0x1a, 0x1c, 0x2e, 0x73, 0x76, 0x63, 0x2e, 0x62, 0x69, 0x7a, 0x2e, 0x76, 0x69, 0x70, 0x2e, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00,
...
var file_svc_biz_vip_noble_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_svc_biz_vip_noble_proto_goTypes = []any{
	...
	(*GetNobleReq)(nil),             // 3: svc.biz.vip.GetNobleReq
	(*GetNobleResp)(nil),            // 4: svc.biz.vip.GetNobleResp
	(*GetNobleListReq)(nil),         // 5: svc.biz.vip.GetNobleListReq
	(*GetNobleListResp)(nil),        // 6: svc.biz.vip.GetNobleListResp
	(*UpdateNobleReq)(nil),          // 7: svc.biz.vip.UpdateNobleReq
	(*UpdateNobleResp)(nil),         // 8: svc.biz.vip.UpdateNobleResp
...
var file_svc_biz_vip_noble_proto_depIdxs = []int32{
	...
	0,  // 2: svc.biz.vip.GetNobleReq.level:type_name -> svc.biz.vip.NobleLevel
	9,  // 3: svc.biz.vip.GetNobleResp.noble:type_name -> svc.biz.vip.NobleInfo
	9,  // 4: svc.biz.vip.GetNobleListResp.items:type_name -> svc.biz.vip.NobleInfo
	0,  // 5: svc.biz.vip.UpdateNobleReq.level:type_name -> svc.biz.vip.NobleLevel
	9,  // 6: svc.biz.vip.UpdateNobleReq.noble:type_name -> svc.biz.vip.NobleInfo
	12, // 7: svc.biz.vip.UpdateNobleReq.update_mask:type_name -> google.protobuf.FieldMask
	0,  // 8: svc.biz.vip.NobleInfo.level:type_name -> svc.biz.vip.NobleLevel
	10, // 9: svc.biz.vip.NobleInfo.rights_free_gifts:type_name -> svc.biz.vip.NobleRightsFreeGift
	11, // 10: svc.biz.vip.NobleInfo.rights_discount_gifts:type_name -> svc.biz.vip.NobleRightsDiscountGift
	13, // 11: svc.biz.vip.NobleInfo.created_at:type_name -> google.protobuf.Timestamp
	13, // 12: svc.biz.vip.NobleInfo.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 13: svc.biz.vip.Noble.CreateNoble:input_type -> svc.biz.vip.CreateNobleReq
	3,  // 14: svc.biz.vip.Noble.GetNoble:input_type -> svc.biz.vip.GetNobleReq
	5,  // 15: svc.biz.vip.Noble.GetNobleList:input_type -> svc.biz.vip.GetNobleListReq
	7,  // 16: svc.biz.vip.Noble.UpdateNoble:input_type -> svc.biz.vip.UpdateNobleReq
	2,  // 17: svc.biz.vip.Noble.CreateNoble:output_type -> svc.biz.vip.CreateNobleResp
	4,  // 18: svc.biz.vip.Noble.GetNoble:output_type -> svc.biz.vip.GetNobleResp
	6,  // 19: svc.biz.vip.Noble.GetNobleList:output_type -> svc.biz.vip.GetNobleListResp
	8,  // 20: svc.biz.vip.Noble.UpdateNoble:output_type -> svc.biz.vip.UpdateNobleResp
