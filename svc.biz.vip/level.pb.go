...
type MGetMemberLevelResp struct {
	...
	Items map[string]*MemberLevelInfo `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func file_svc_biz_vip_level_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_svc_biz_vip_level_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*MGetMemberLevelReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_svc_biz_vip_level_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*MGetMemberLevelResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_svc_biz_vip_level_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_svc_biz_vip_level_proto_msgTypes[14].Exporter = func(v any, i int) any {
