...
func (c *fanbaseMemberClient) JoinFanbase(ctx context.Context, in *JoinFanbaseReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, FanbaseMember_JoinFanbase_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fanbaseMemberClient) LeaveFanbase(ctx context.Context, in *LeaveFanbaseReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, FanbaseMember_LeaveFanbase_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fanbaseMemberClient) GetFanbaseMember(ctx context.Context, in *GetFanbaseMemberReq, opts ...grpc.CallOption) (*GetFanbaseMemberResp, error) {
	...
	err := c.cc.Invoke(ctx, FanbaseMember_GetFanbaseMember_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fanbaseMemberClient) GetFanbaseMembertByMemberID(ctx context.Context, in *GetFanbaseMembertByMemberIDResp, opts ...grpc.CallOption) (*GetListResp, error) {
	out := new(GetListResp)
	err := c.cc.Invoke(ctx, FanbaseMember_GetFanbaseMembertByMemberID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
