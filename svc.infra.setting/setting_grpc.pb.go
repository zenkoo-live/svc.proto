...
type SettingClient interface {
	...
	ListConfigurations(ctx context.Context, in *ListConfigurationsReq, opts ...grpc.CallOption) (*ListConfigurationsResp, error)
...
func (c *settingClient) InitDB(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*InitDBResp, error) {
	out := new(InitDBResp)
	err := c.cc.Invoke(ctx, "/svc.infra.setting.Setting/InitDB", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingClient) GetConfiguration(ctx context.Context, in *GetConfigurationReq, opts ...grpc.CallOption) (*GetConfigurationResp, error) {
	...
	err := c.cc.Invoke(ctx, "/svc.infra.setting.Setting/GetConfiguration", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingClient) ListConfigurations(ctx context.Context, in *ListConfigurationsReq, opts ...grpc.CallOption) (*ListConfigurationsResp, error) {
	out := new(ListConfigurationsResp)
	err := c.cc.Invoke(ctx, "/svc.infra.setting.Setting/ListConfigurations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingClient) AddConfiguration(ctx context.Context, in *AddConfigurationReq, opts ...grpc.CallOption) (*AddConfigurationResp, error) {
	...
	err := c.cc.Invoke(ctx, "/svc.infra.setting.Setting/AddConfiguration", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingClient) UpdateConfiguration(ctx context.Context, in *UpdateConfigurationReq, opts ...grpc.CallOption) (*UpdateConfigurationResp, error) {
	...
	err := c.cc.Invoke(ctx, "/svc.infra.setting.Setting/UpdateConfiguration", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingClient) DeleteConfiguration(ctx context.Context, in *DeleteConfigurationReq, opts ...grpc.CallOption) (*DeleteConfigurationResp, error) {
	...
	err := c.cc.Invoke(ctx, "/svc.infra.setting.Setting/DeleteConfiguration", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *settingClient) Greeting(ctx context.Context, in *SettingGreetingReq, opts ...grpc.CallOption) (*SettingGreetingResp, error) {
	...
	err := c.cc.Invoke(ctx, "/svc.infra.setting.Setting/Greeting", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSettingServer) ListConfigurations(context.Context, *ListConfigurationsReq) (*ListConfigurationsResp, error) {
...
func _Setting_InitDB_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc.infra.setting.Setting/InitDB",
	}
...
func _Setting_GetConfiguration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc.infra.setting.Setting/GetConfiguration",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Setting_ListConfigurations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListConfigurationsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SettingServer).ListConfigurations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc.infra.setting.Setting/ListConfigurations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SettingServer).ListConfigurations(ctx, req.(*ListConfigurationsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Setting_AddConfiguration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc.infra.setting.Setting/AddConfiguration",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Setting_UpdateConfiguration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc.infra.setting.Setting/UpdateConfiguration",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Setting_DeleteConfiguration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc.infra.setting.Setting/DeleteConfiguration",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Setting_Greeting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/svc.infra.setting.Setting/Greeting",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Setting_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Setting_ListConfigurations_Handler,
		},
		{
