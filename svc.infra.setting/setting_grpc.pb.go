...
const (
	...
	Setting_ListConfigurations_FullMethodName  = "/svc.infra.setting.Setting/ListConfigurations"
...
func (c *settingClient) ListConfigurations(ctx context.Context, in *ListConfigurationsReq, opts ...grpc.CallOption) (*ListConfigurationsResp, error) {
	...
	err := c.cc.Invoke(ctx, Setting_ListConfigurations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Setting_ListConfigurations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Setting_ListConfigurations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
