...
// UnimplementedStreamerViewerRankServer must be embedded to have
...
func (UnimplementedStreamerViewerRankServer) testEmbeddedByValue()                            {}
...
func RegisterStreamerViewerRankServer(s grpc.ServiceRegistrar, srv StreamerViewerRankServer) {
	// If the following call pancis, it indicates UnimplementedStreamerViewerRankServer was
