...
- [svc.biz.trade/trade.proto](#svc-biz-trade_trade-proto)
    ...
    - [CoinRechargeReq](#svc-biz-trade-CoinRechargeReq)
...
- [svc.infra.pay/pay.proto](#svc-infra-pay_pay-proto)
    ...
    - [RecordStatus](#svc-infra-pay-RecordStatus)
    - [RecordType](#svc-infra-pay-RecordType)
...
- [svc.biz.asset/mq.proto](#svc-biz-asset_mq-proto)
    - [AssetUserMoneyIncrTopicInfo](#svc-biz-asset-AssetUserMoneyIncrTopicInfo)
...
- [svc.infra.generator/generator.proto](#svc-infra-generator_generator-proto)
    ...
    - [NextIDResp](#svc-infra-generator-NextIDResp)
    - [OrdianIDReq](#svc-infra-generator-OrdianIDReq)
...
- [svc.infra.notifier/notifier.proto](#svc-infra-notifier_notifier-proto)
    ...
    - [SmsBizSendLogListResponse.SmsBizSendLogItem](#svc-infra-notifier-SmsBizSendLogListResponse-SmsBizSendLogItem)
...
- [svc.biz.vip/level.proto](#svc-biz-vip_level-proto)
    ...
    - [GetAllLevelListReq](#svc-biz-vip-GetAllLevelListReq)
...
- [svc.biz.gift/wishlist.proto](#svc-biz-gift_wishlist-proto)
    - [EmptyRequest](#svc-biz-gift-EmptyRequest)
    - [EmptyResponse](#svc-biz-gift-EmptyResponse)
    - [EnabledStatusInfo](#svc-biz-gift-EnabledStatusInfo)
    ...
    - [UpdateGiftsReq](#svc-biz-gift-UpdateGiftsReq)
    - [WishGiftInfo](#svc-biz-gift-WishGiftInfo)
    - [WishGiftInfoField](#svc-biz-gift-WishGiftInfoField)
    - [WishlistInfoResp](#svc-biz-gift-WishlistInfoResp)
  
    - [LiveWishlist](#svc-biz-gift-LiveWishlist)
...
<a name="svc-infra-pay-DetailPayRecord"></a>
...
| app_id | [string](#string) |  | 应用ID |
| channel_id | [string](#string) |  | 渠道ID |
| channel_type_id | [string](#string) |  | 渠道支付方式 |
| creator | [string](#string) |  | 操作者 |
| channel_type_name | [string](#string) |  | 渠道支付方式名称 |
...
<a name="svc-infra-pay-DetailPayRecordRequest"></a>

### DetailPayRecordRequest
...
| order_no | [string](#string) |  | 订单号 |
| channel_id | [string](#string) |  | 渠道ID |
| start_at | [google.protobuf.Timestamp](#google-protobuf-Timestamp) |  | 结束时间 |
| end_at | [google.protobuf.Timestamp](#google-protobuf-Timestamp) |  | 结束时间 |
| status | [PayStatus](#svc-infra-pay-PayStatus) | optional | 支付状态 |
| not_status | [PayStatus](#svc-infra-pay-PayStatus) | optional | 不等于某个状态 |
| support_channel_name | [string](#string) |  | 可支持的渠道名称 |
| channel_type_id | [string](#string) |  | 渠道类型 |
...
<a name="svc-infra-pay-DetailPayRecordResponse"></a>

### DetailPayRecordResponse
...
| list | [DetailPayRecord](#svc-infra-pay-DetailPayRecord) | repeated | 记录 |
...
| platform | [string](#string) |  | 充值的端口: ios,android,h5,pc这种 |
| creator | [string](#string) |  | 充值操作人 |
| remark | [string](#string) | optional | 充值备注 |
...
<a name="svc-infra-pay-ReissueRequest"></a>
...
<a name="svc-infra-pay-ReissueResponse"></a>
...
<a name="svc-infra-pay-UpdateRecordStatusRequest"></a>
...
| status | [RecordStatus](#svc-infra-pay-RecordStatus) |  |  |
| type | [RecordType](#svc-infra-pay-RecordType) |  |  |
...
<a name="svc-infra-pay-UpdateRecordStatusResponse"></a>
...
<a name="svc-infra-pay-RecordStatus"></a>
...
<a name="svc-infra-pay-RecordType"></a>
...
| DetailPayRecords | [DetailPayRecordRequest](#svc-infra-pay-DetailPayRecordRequest) | [DetailPayRecordResponse](#svc-infra-pay-DetailPayRecordResponse) | 详细的充值订单记录 |
| Reissue | [ReissueRequest](#svc-infra-pay-ReissueRequest) | [ReissueResponse](#svc-infra-pay-ReissueResponse) | 补发订单 |
...
<a name="svc-biz-room-StatLiveReq"></a>
...
<a name="svc-biz-room-StatLiveResp"></a>
...
<a name="svc-biz-room-MuteUserCommResp"></a>
...
<a name="svc-biz-asset_mq-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## svc.biz.asset/mq.proto



<a name="svc-biz-asset-AssetUserMoneyIncrTopicInfo"></a>

### AssetUserMoneyIncrTopicInfo
...
<a name="svc-biz-asset-GetStreamerCoinTotalReq"></a>

### GetStreamerCoinTotalReq
...
<a name="svc-biz-asset-GetStreamerCoinTotalResp"></a>

### GetStreamerCoinTotalResp



| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| value_map | [GetStreamerCoinTotalResp.ValueMapEntry](#svc-biz-asset-GetStreamerCoinTotalResp-ValueMapEntry) | repeated | trans_type-&gt;value,增加的为正数,减少的为负数 |
...
<a name="svc-biz-asset-GetStreamerCoinTotalResp-ValueMapEntry"></a>

### GetStreamerCoinTotalResp.ValueMapEntry
...
| GetStreamerCoinTotal | [GetStreamerCoinTotalReq](#svc-biz-asset-GetStreamerCoinTotalReq) | [GetStreamerCoinTotalResp](#svc-biz-asset-GetStreamerCoinTotalResp) |  |
...
| member_id | [string](#string) |  | 正向关系传这个 |
| r_member_id | [string](#string) |  | 反向关系传这个 |
...
<a name="svc-infra-generator-IsPrettyIDReq"></a>
...
<a name="svc-infra-generator-IsPrettyIDResp"></a>
...
<a name="svc-infra-generator-NextIDReq"></a>
...
<a name="svc-infra-generator-NextIDResp"></a>
...
<a name="svc-infra-generator-OrdianIDReq"></a>
...
<a name="svc-infra-generator-OrdianIDResp"></a>
...
<a name="svc-infra-list_list-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## svc.infra.list/list.proto
...
| ----- | ---- | ----- | ----------- |
| cnt | [int64](#int64) |  |  |
| list | [SmsBizSendLogListResponse.SmsBizSendLogItem](#svc-infra-notifier-SmsBizSendLogListResponse-SmsBizSendLogItem) | repeated |  |
...
<a name="svc-infra-notifier-SmsBizSendLogListResponse-SmsBizSendLogItem"></a>

### SmsBizSendLogListResponse.SmsBizSendLogItem



| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| sms_biz_send_log | [SmsBizSendLog](#svc-infra-notifier-SmsBizSendLog) |  |  |
...
| template_name | [string](#string) |  | 模版名称 |
...
<a name="svc-biz-vip-GetAllLevelListReq"></a>
...
<a name="svc-biz-gift_wishlist-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## svc.biz.gift/wishlist.proto



<a name="svc-biz-gift-EmptyRequest"></a>
...
<a name="svc-biz-gift-EmptyResponse"></a>
...
<a name="svc-biz-gift-EnabledStatusInfo"></a>
...
<a name="svc-biz-gift-GetWishlistByRoomIdReq"></a>

### GetWishlistByRoomIdReq
...
<a name="svc-biz-gift-LiveWishlistCommonDeleteResp"></a>

### LiveWishlistCommonDeleteResp
公用删除反回


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| affect_rows | [int64](#int64) |  |  |
...
<a name="svc-biz-gift-LiveWishlistDetailAddReq"></a>

### LiveWishlistDetailAddReq



| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| room_id | [string](#string) |  | 房间号 |
| gift_id | [string](#string) |  | 礼物ID |
| target_quantity | [int32](#int32) |  | 目标数量 |
...
| ----- | ---- | ----- | ----------- |
| room_id | [string](#string) |  | 房间ID |
| is_automode | [bool](#bool) |  | 是否为自动重置(每天0点自动重置心愿单数据) |
| enabled | [bool](#bool) |  | 是否启用心愿单 |
| detail | [WishGiftInfoField](#svc-biz-gift-WishGiftInfoField) | repeated | 心愿单礼物配置 |
...
<a name="svc-biz-gift-SetWishlistResp"></a>
...
<a name="svc-biz-gift-UpdateDetailGiftItemsResp"></a>

### UpdateDetailGiftItemsResp
...
| room_id | [string](#string) |  | 房间ID |
| gift_id | [string](#string) |  | 礼物ID |
| received_quantity | [string](#string) |  | 收到的数量 |
| target_quantity | [string](#string) |  | 目标数 |
| is_completed | [bool](#bool) |  | 是否已完成当前礼物目标 |
...
<a name="svc-biz-gift-UpdateGiftsReq"></a>
...
| ----- | ---- | ----- | ----------- |
| room_id | [string](#string) |  | 房间ID |
| detail | [WishGiftInfoField](#svc-biz-gift-WishGiftInfoField) | repeated | 礼物详情 |
...
<a name="svc-biz-gift-WishGiftInfo"></a>
...
| ----- | ---- | ----- | ----------- |
| id | [string](#string) |  |  |
| wishlist_id | [string](#string) |  | 心愿单ID |
| gift_id | [string](#string) |  | 礼物ID |
| gift_name | [string](#string) |  | 礼物名称 |
| gift_icon | [string](#string) |  | 礼物图标 |
| gift_price | [int32](#int32) |  | 礼物价格 |
| gift_total_price | [int32](#int32) |  | 礼物总价格 |
| target_quantity | [int32](#int32) |  | 目标数量 |
| received_quantity | [int32](#int32) |  | 完成数量 |
| is_completed | [bool](#bool) |  | 是否已完成当前心愿 |
...
<a name="svc-biz-gift-WishGiftInfoField"></a>
...
<a name="svc-biz-gift-WishlistInfoResp"></a>
...
| room_id | [string](#string) |  | 房间ID |
| live_id | [string](#string) |  | 直播ID |
| name | [string](#string) |  | 心愿单名称 |
| desc | [string](#string) |  | 心愿单描述 |
| is_active | [bool](#bool) |  | 是否为激活的心愿单 |
| is_automode | [bool](#bool) |  | 是否为自动重置(每天0点自动重置心愿单数据) |
| is_completed | [bool](#bool) |  | 是否已完成 |
| detail | [WishGiftInfo](#svc-biz-gift-WishGiftInfo) | repeated | 心愿单礼物列表 |
...
<a name="svc-biz-gift-LiveWishlist"></a>
...
| Method Name | Request Type | Response Type | Description |
| ----------- | ------------ | ------------- | ------------|
| SetWishlist | [SetWishlistReq](#svc-biz-gift-SetWishlistReq) | [SetWishlistResp](#svc-biz-gift-SetWishlistResp) | 设置心愿单 |
| GetByRoomId | [GetWishlistByRoomIdReq](#svc-biz-gift-GetWishlistByRoomIdReq) | [WishlistInfoResp](#svc-biz-gift-WishlistInfoResp) | 查询指定房间的心愿单信息 |
| UpdateWishGifts | [UpdateGiftsReq](#svc-biz-gift-UpdateGiftsReq) | [WishlistInfoResp](#svc-biz-gift-WishlistInfoResp) | 修改心愿单礼物 |
