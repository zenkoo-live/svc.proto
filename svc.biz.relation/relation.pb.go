...
func file_svc_biz_relation_relation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_svc_biz_relation_relation_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_svc_biz_relation_relation_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
