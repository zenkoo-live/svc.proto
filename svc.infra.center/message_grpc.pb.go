...
const (
	LinkMessage_SendGlobal_FullMethodName  = "/svc.infra.center.LinkMessage/SendGlobal"
	LinkMessage_SendGroup_FullMethodName   = "/svc.infra.center.LinkMessage/SendGroup"
	LinkMessage_SendAccount_FullMethodName = "/svc.infra.center.LinkMessage/SendAccount"
	LinkMessage_SendDevice_FullMethodName  = "/svc.infra.center.LinkMessage/SendDevice"
	LinkMessage_SendSession_FullMethodName = "/svc.infra.center.LinkMessage/SendSession"
)
...
func (c *linkMessageClient) SendGlobal(ctx context.Context, in *SendGlobalRequest, opts ...grpc.CallOption) (*SendGlobalResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkMessage_SendGlobal_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkMessageClient) SendGroup(ctx context.Context, in *SendGroupRequest, opts ...grpc.CallOption) (*SendGroupResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkMessage_SendGroup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkMessageClient) SendAccount(ctx context.Context, in *SendAccountRequest, opts ...grpc.CallOption) (*SendAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkMessage_SendAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkMessageClient) SendDevice(ctx context.Context, in *SendDeviceRequest, opts ...grpc.CallOption) (*SendDeviceResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkMessage_SendDevice_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkMessageClient) SendSession(ctx context.Context, in *SendSessionRequest, opts ...grpc.CallOption) (*SendSessionResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkMessage_SendSession_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var LinkMessage_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "svc.infra.center.LinkMessage",
	...
	Metadata: "svc.infra.center/message.proto",
}
