...
var file_svc_infra_center_instruction_proto_rawDesc = []byte{
	...
	0x70, 0x5f, 0x69, 0x64, 0x18, 0x11, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75,
...
var file_svc_infra_center_instruction_proto_goTypes = []any{
...
func file_svc_infra_center_instruction_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_svc_infra_center_instruction_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_svc_infra_center_instruction_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_svc_infra_center_instruction_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_svc_infra_center_instruction_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_svc_infra_center_instruction_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_svc_infra_center_instruction_proto_msgTypes[5].Exporter = func(v any, i int) any {
