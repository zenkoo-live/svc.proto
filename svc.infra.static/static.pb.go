...
func (x *UploadStreamRequestMessage) GetData() isUploadStreamRequestMessage_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *UploadStreamRequestMessage) GetInfo() *StreamRequestInfo {
	if x != nil {
		if x, ok := x.Data.(*UploadStreamRequestMessage_Info); ok {
			return x.Info
		}
	}
	return nil
...
func (x *UploadStreamRequestMessage) GetBinary() []byte {
	if x != nil {
		if x, ok := x.Data.(*UploadStreamRequestMessage_Binary); ok {
			return x.Binary
		}
	}
	return nil
