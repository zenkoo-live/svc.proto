...
var file_svc_biz_asset_mq_proto_rawDesc = []byte{
...
var (
	...
	file_svc_biz_asset_mq_proto_rawDescData = file_svc_biz_asset_mq_proto_rawDesc
)

func file_svc_biz_asset_mq_proto_rawDescGZIP() []byte {
	file_svc_biz_asset_mq_proto_rawDescOnce.Do(func() {
		file_svc_biz_asset_mq_proto_rawDescData = protoimpl.X.CompressGZIP(file_svc_biz_asset_mq_proto_rawDescData)
	})
...
func file_svc_biz_asset_mq_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_svc_biz_asset_mq_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*AssetUserMoneyIncrTopicInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_svc_biz_asset_mq_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_svc_biz_asset_mq_proto_rawDesc = nil
