...
const (
	LinkGateway_List_FullMethodName   = "/svc.infra.link.LinkGateway/List"
	LinkGateway_Get_FullMethodName    = "/svc.infra.link.LinkGateway/Get"
	LinkGateway_Select_FullMethodName = "/svc.infra.link.LinkGateway/Select"
)
...
func (c *linkGatewayClient) List(ctx context.Context, in *ListGatewayRequest, opts ...grpc.CallOption) (*ListGatewayResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkGateway_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkGatewayClient) Get(ctx context.Context, in *GetGatewayRequest, opts ...grpc.CallOption) (*GetGatewayResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkGateway_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkGatewayClient) Select(ctx context.Context, in *SelectGatewayRequest, opts ...grpc.CallOption) (*SelectGatewayResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkGateway_Select_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLinkGatewayServer must be embedded to have
...
func (UnimplementedLinkGatewayServer) testEmbeddedByValue()                     {}
...
func RegisterLinkGatewayServer(s grpc.ServiceRegistrar, srv LinkGatewayServer) {
	// If the following call pancis, it indicates UnimplementedLinkGatewayServer was
...
var LinkGateway_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "svc.infra.link.LinkGateway",
