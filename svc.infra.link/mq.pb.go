...
var file_svc_infra_link_mq_proto_rawDesc = string([]byte{
...
var (
	...
	file_svc_infra_link_mq_proto_rawDescData []byte
)

func file_svc_infra_link_mq_proto_rawDescGZIP() []byte {
	file_svc_infra_link_mq_proto_rawDescOnce.Do(func() {
		file_svc_infra_link_mq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_svc_infra_link_mq_proto_rawDesc), len(file_svc_infra_link_mq_proto_rawDesc)))
	})
...
func file_svc_infra_link_mq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_svc_infra_link_mq_proto_rawDesc), len(file_svc_infra_link_mq_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
