...
type CheckSessionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Online        map[string]bool        `protobuf:"bytes,1,rep,name=online,proto3" json:"online,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 连接ID => 是否在线
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CheckAccountResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Online        map[string]bool        `protobuf:"bytes,1,rep,name=online,proto3" json:"online,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 账号ID => 是否在线
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CheckDeviceResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Online        map[string]bool        `protobuf:"bytes,1,rep,name=online,proto3" json:"online,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 设备标识 => 是否在线
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_svc_infra_link_stat_proto_rawDesc = string([]byte{
...
var (
	...
	file_svc_infra_link_stat_proto_rawDescData []byte
)

func file_svc_infra_link_stat_proto_rawDescGZIP() []byte {
	file_svc_infra_link_stat_proto_rawDescOnce.Do(func() {
		file_svc_infra_link_stat_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_svc_infra_link_stat_proto_rawDesc), len(file_svc_infra_link_stat_proto_rawDesc)))
	})
...
func file_svc_infra_link_stat_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_svc_infra_link_stat_proto_rawDesc), len(file_svc_infra_link_stat_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   24,
			NumExtensions: 0,
			NumServices:   1,
