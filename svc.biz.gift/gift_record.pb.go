...
type GetStatResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TotalNum      int64                  `protobuf:"varint,1,opt,name=total_num,json=totalNum,proto3" json:"total_num,omitempty"`       // 礼物总数
	TotalPrice    int64                  `protobuf:"varint,2,opt,name=total_price,json=totalPrice,proto3" json:"total_price,omitempty"` // 礼物代币总数
	TotalUser     int64                  `protobuf:"varint,3,opt,name=total_user,json=totalUser,proto3" json:"total_user,omitempty"`    // 礼物用户总数
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetStatResp) GetTotalNum() int64 {
	if x != nil {
		return x.TotalNum
	}
	return 0
...
func (x *GetStatResp) GetTotalPrice() int64 {
	if x != nil {
		return x.TotalPrice
	}
	return 0
...
func (x *GetStatResp) GetTotalUser() int64 {
	if x != nil {
		return x.TotalUser
	}
	return 0
...
var file_svc_biz_gift_gift_record_proto_rawDesc = string([]byte{
	...
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x08, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x4e, 0x75, 0x6d, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x6f, 0x74,
	0x61, 0x6c, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a,
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x6f,
	0x74, 0x61, 0x6c, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09,
...
var (
	...
	file_svc_biz_gift_gift_record_proto_rawDescData []byte
)

func file_svc_biz_gift_gift_record_proto_rawDescGZIP() []byte {
	file_svc_biz_gift_gift_record_proto_rawDescOnce.Do(func() {
		file_svc_biz_gift_gift_record_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_svc_biz_gift_gift_record_proto_rawDesc), len(file_svc_biz_gift_gift_record_proto_rawDesc)))
	})
...
func file_svc_biz_gift_gift_record_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_svc_biz_gift_gift_record_proto_rawDesc), len(file_svc_biz_gift_gift_record_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
