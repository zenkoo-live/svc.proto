...
func file_svc_biz_gift_wishlist_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_svc_biz_gift_wishlist_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetWishlistReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_svc_biz_gift_wishlist_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
